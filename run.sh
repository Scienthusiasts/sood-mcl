...
# sh run.sh > log/dtbaseline/DOTA1.5/ss-branch/global-w_refinehead/joint-score-sigmoid_burn-in-12800_orcnn-head_all-refine-loss_box-O2M-loss_detach_GA_ssloss-joint-jsd-dim0-w1.0_8_modify-batch-nms/terminal_log.log 2>&1
/home/yht/.conda/envs/sood-mcl/bin/python -m torch.distributed.launch --node_rank=0 --master_addr="127.0.0.1" --nproc_per_node=2 --nnodes=1 --master_port=29560\
    train.py configs_dota15/denseteacher_baseline/denseteacher_fcos_refineORCNNhead_ss_dota15_10p.py \
    --launcher pytorch \
    --work-dir log/dtbaseline/DOTA1.5/ss-branch/global-w_refinehead/joint-score-sigmoid_burn-in-12800_orcnn-head_all-refine-loss_box-O2M-loss_detach_GA_ssloss-joint-jsd-dim0-w1.0_8_modify-batch-nms

# 10per_dtbaseline_gihead_train DOTA1.5
# sh run.sh > log/dtbaseline/DOTA1.5/ss-branch/global-w_gihead/joint-score-sigmoid_burn-in-12800_gi-head_all-refine-loss_box-O2M-loss_detach_GA_ssloss-joint-jsd-dim0-w1.0_reuse-nms-cls/terminal_log.log 2>&1
# /home/yht/.conda/envs/sood-mcl/bin/python -m torch.distributed.launch --node_rank=0 --master_addr="127.0.0.1" --nproc_per_node=2 --nnodes=1 --master_port=29562\
#     train.py configs_dota15/denseteacher_baseline/denseteacher_fcos_refineGIhead_ss_dota15_10p.py \
#     --launcher pytorch \
#     --work-dir log/dtbaseline/DOTA1.5/ss-branch/global-w_gihead/joint-score-sigmoid_burn-in-12800_gi-head_all-refine-loss_box-O2M-loss_detach_GA_ssloss-joint-jsd-dim0-w1.0_reuse-nms-cls
