...
# 10per_globalw_ss 
# sh run_new.sh > log/new/globalw/ss/burn-in-6400_joint-jsdloss-dim0-w1.0_roiuloss-w1.0/terminal_log.log 2>&1
# /home/yht/.conda/envs/sood-mcl/bin/python -m torch.distributed.launch --node_rank=0 --master_addr="127.0.0.1" --nproc_per_node=2 --nnodes=1 --master_port=29560\
#     train.py configs_dota15/new_idea/globalw_fcos_ss_dota15_10p.py \
#     --launcher pytorch \
#     --work-dir log/new/globalw/ss/burn-in-6400_joint-jsdloss-dim0-w0.1_roiuloss-w1.0
