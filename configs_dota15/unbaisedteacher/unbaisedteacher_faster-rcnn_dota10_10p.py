...
# model settings
detector = dict(
    # semi_mmrotate/models/detectors/semi_rotated_fasterrcnn.py (只改了forward_train()) -> 
    # 继承 mmrotate-0.3.4/mmrotate/models/detectors/rotate_faster_rcnn.py
    type='SemiRotatedFasterRCNN',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
