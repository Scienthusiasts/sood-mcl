...
# mask掉unlabeled的区域的图像
# train_unsup_image_dir = f'/data/yht/data/DOTA-1.0-1.5_ss_size-1024_gap-200/sparse_PECL/{version}/sparse_ann_{ann_ratio}per/train_mask_unlabeled_images'
