...
DATA_SAMPLERS = Registry("sampler")

DATA_SAMPLERS.register_module(module=DistributedGroupSampler)
DATA_SAMPLERS.register_module(module=DistributedSampler)
DATA_SAMPLERS.register_module(module=GroupSampler)
