...
# yan modified from /data/yht/code/sood-mcl/mmrotate-0.3.4/mmrotate/models/roi_heads/rotate_standard_roi_head.py
...
class RotatedFRCNNRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        super(RotatedFRCNNRoIHead, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        if self.with_bbox:
            ...
            for i in range(num_imgs):
                ...
                # added by yan:
                proposal_list[i] = obb2xyxy(proposal_list[i], self.version)
                # 标签分配
