...
class RotatedSparseFCOS(RotatedSemiDetector):
    def __init__(self, nc, model: dict, train_cfg=None, test_cfg=None, symmetry_aware=False, pretrained=None):
        super(RotatedSparseFCOS, self).__init__(
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(RotatedSparseFCOS, self).forward_train(imgs, img_metas, **kwargs)
        losses = dict()
